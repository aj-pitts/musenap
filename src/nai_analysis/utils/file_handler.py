...
def load_mcmc_results(mcmc_dir: str, nworkers = 8, verbose = False) -> object:
    util.check_filepath(mcmc_dir, mkdir=False)
    ...
    iterator = tqdm(args, desc="combining MCMC results") if verbose else args
